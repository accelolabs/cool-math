...
| - | - | - | - | - |
| Точка | Конечный (I) | Да | Односторонние пределы равны, но точка не определена или не равна им. | disc_1 |
| Скачок | Конечный (I) | Нет | Односторонние переделы не совпадают | disc_2 |
| Бесконечный | Бесконечный (II) | Нет | Один из односторонних пределов бесконечен. | disc_3 |
