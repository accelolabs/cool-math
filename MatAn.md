...
> <img src="img/TwoVariableFunction.png" width="148"> <img src="img/TwoVariableFunction2.png" width="148"> <img src="img/TwoVariableFunction3.png" width="148"> <br/>
...
При пересечении поверхности плоскостью $x = x_0$, получаем <br/>
...
### Дифференциал
>*Определение*
>**Дифференциал** - это **линейная часть** приращения функции<br/> 
> <img src="img/diff.png" width="512"> <br/> 
> <img src="img/diff_addition.png" width="512"> <br/>
**Геометрический смысл:**<br/>
> <img src="img/diff_geometrically.png" width="512"> <br/>

### Применение в приближенных вычислениях
> Если функция дифференцируема в точке $x$, то ее приращение можно записать в таком виде: $\Delta y = dy + o(\Delta x)_{\Delta x \to 0}$<br/>
То есть при **достаточно малых** $\Delta x$ дифференциал может служить хорошим **приближением приращения функции**.<br/>
>$\Delta y \approx dy = f(x)'dx$ <br/>
>Пример:
Пусть надо вычислить значение $f(x)$ в точке $x$.Однако появилась необходимость заменить $x$ на приближенное значение $x + \Delta x$<br/>
Тогда возникает приближеннное равенство $f(x) = f(x + \Delta x )$ его абсолютная погрешность равна $\left | y \right | = \left | f(x + \Delta x) - f(x) \right |$<br/>
Если функция  **дифференцируема в точке** , то из формулы следует, что при малых  можно считать, что абсолютная погрешность рассматриваемого приближения равна приближению абсолютной величине дифференциала функции: $ \left | \Delta y \right | = \left | dy \right |$ вычисленного для соответствующего приращения $\Delta x$.
...
*Кольцо* -  алгебраическая структура, которая содержит сумму, произведение любых двух своих элементов. <br/>
**Поле** - числовое кольцо, в котором содержится частное двух своих числе. <br/>

**Скаляр** - элемент поля (число).

### Геометрическое приложение частной производной
Функция $z(x, y)$ задает поверхность F(x, z, y). <br/>
