...
**Базис линейного пространства** - !TODO Векторы базиса называются базисными векторами. <br/>
...
**Координаты вектора** - упорядоченный набор коэффициентов, с помощью которых данный вектор выражается через базисные векторы, называется *координатами* этого вектора в данном базисе
